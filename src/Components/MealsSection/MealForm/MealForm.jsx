  ...
  return (
    <>
      <tr className={styles.formRow}>
        ...
        <td data-label="Proteins:" className={styles.previewValue}>
          {calculated?.proteins || ""}g
        </td>
        <td data-label="Carbs:" className={styles.previewValue}>
          {calculated?.carbs || ""}g
        </td>
        <td data-label="Fats:" className={styles.previewValue}>
          {calculated?.fats || ""}g
        </td>
        <td data-label="Calories:" className={styles.previewValue}>
