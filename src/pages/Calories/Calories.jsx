...
export default function CaloriesSection() {
  ...
  const latestWeight =
    progress && progress.length > 0
      ? progress[progress.length - 1].weight_kg
      : null;
  const initialWeight =
    progress && progress.length > 0 ? progress[0].weight_kg : null;
  ...
  useEffect(() => {
    if (goalType && savedGoal && latestWeight) {
      ...
      if (
        ...
        showMessage(
          "Your target weight is lower than your current weight. Please adjust your goal to match your focus.",
          "error"
        );
      }
      ...
      if (
        ...
        showMessage(
          "Your target weight is higher than your current weight. Please adjust your goal to match your focus.",
          "error"
        );
      }
    }
        ...
        <div className={styles.blockMain}>
          <div className={styles.block}>
            <div className={styles.focus}>
              <h2>Your Focus</h2>
              <p>
                Select your specific goal to receive tailored recommendations.
              </p>
            ...
            <p>
              Based on your profile and progress data, we estimate your
              maintenance calories to be:
            </p>
            <span className={styles.mainValue}>
              {profile && latestWeight
                ? `${calculateCalories(profile, goalType)} kcal/day`
                : "Loading..."}
            </span>
          </div>
          ...
          <div className={styles.block}>
            ...
            {savedGoal && latestWeight && (
              <div className={styles.progressBox}>
                ...
                <p>
                  Goal weight: <strong>{savedGoal} kg</strong>
                </p>
